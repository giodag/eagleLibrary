...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("eagleLibraryGateway");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("eagleLibraryGateway");
        ...
        config.getMapConfigs().put("com.univaq.eaglelibrarygateway.domain.*", initializeDomainMapConfig(jHipsterProperties));
